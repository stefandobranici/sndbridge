export const djsRepository = [
  ...
  },
  {
    ...
    description:
      "After being a Reggae host and MC for many of my younger years my head turned to being a collector of Soulful House Music in 2013. I have a natural love for vocals (especially Female) and used to freely share my Tracks with Family and Friends. I then treated myself to a Controller and taught myself to Beatmatch, in 2017 made the decision to start playing locally just to gain the confidence. Previous Audio mixes can be found on Mixcloud (TH3 MARQUES) ..Numerous mixes including Soulful, Funky, Deep and Afro House for your listening pleasure. If Music is food ....Lets Eat..!!",
    profile:
